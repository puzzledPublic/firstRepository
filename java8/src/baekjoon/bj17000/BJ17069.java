...
//파이프 옮기기 2
//(파이프 옮기기 1(BJ17070)에서 N이 커진 버전)
//경우의 수가 int형을 넘어서므로 long을 사용한다.
public class BJ17069 {
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		long[][][] home = new long[N][N][3];	//home[i][j][k] = k모양(0=가로, 1=대각선, 2=세로)으로 (i,j)를 도착하는 경우의 수
		for(int i = 0; i < N; i++) {
		...
		long result = (home[N - 1][N - 1][0] + home[N - 1][N - 1][1] + home[N - 1][N - 1][2]);
